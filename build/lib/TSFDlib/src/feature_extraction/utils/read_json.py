...
#
# def feat_extract_exc(dictionary, signal_window, signal_label, FS = 100, iteration=None):
#     """
...
#     with open('../data/extracted_features/sheet.pickle', 'rb') as handle:
#         sheet_cases = pickle.load(handle)
...
#             if sheet_cases[1][sheet_cases[0].index(feat)]:
#
...
#                 if free_total[i] != '' :
#
#                     for n, v in free_total[i].iteritems():
...
#     ordered=zip(names,func_results)
#     ordered.sort()
