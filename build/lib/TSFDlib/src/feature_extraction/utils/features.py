...
#from matplotlib.mlab import psd, find
#from matplotlib.pyplot import plot, show, xlabel, ylabel, title, figure, vlines

#from novainstrumentation.ARparameters import lpc_coef, lpcar2cc
